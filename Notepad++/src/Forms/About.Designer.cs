namespace Knuddels.Forms {
	partial class About {
		...
		private void InitializeComponent() {
			...
			this.tableLayoutPanel.Controls.Add(this.close, 1, 5);
			...
			this.tableLayoutPanel.SetRowSpan(this.image, 6);
			this.image.Size = new System.Drawing.Size(131, 259);
			this.image.TabIndex = 12;
			this.image.TabStop = false;
			this.image.Click += new System.EventHandler(this.logoPictureBox_Click);
			// 
			// labelProductName
			// 
			...
			this.close.Location = new System.Drawing.Point(339, 239);
